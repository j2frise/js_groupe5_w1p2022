...
function level1() {
  ...
  oxo.animation.moveElementWithArrowKeys(koalaLevel1, 15);
  ...
  gameOverLevel1 = setInterval(function() {
    fire_is_gameover(koalaLevel1);
  }, 1000);
  exitLevel1 = setInterval(it_is_exit, 1000);

  actionFire1 = setInterval(useExtinguisher, 1000);
  actionAxe1 = setInterval(useAxe, 1000);
  actionShovel1 = setInterval(function() {
    useShovel("arena");
  }, 1000);
...
function level2() {
  ...
  eventClickWeap("arena2");
  gameOverLevel2 = setInterval(function() {
    fire_is_gameover(koalaLevel2);
  }, 1000);
  exitLevel2 = setInterval(it_is_exit2, 1000);
  actionFire2 = setInterval(useExtinguisher, 1000);
  actionAxe2 = setInterval(useAxe, 1000);
  actionShovel2 = setInterval(function() {
    useShovel("arena2");
  }, 1000);
}
...
function level3() {
  ...
  eventClickWeap("arena3");
  gameOverLevel3 = setInterval(function() {
    fire_is_gameover(koalaLevel3);
  }, 1000);
...
function level4() {
  ...
  eventClickWeap("arena4");
  gameOverLevel4 = setInterval(function() {
    fire_is_gameover(koalaLevel4);
  }, 1000);
...
function autoMoveElement() {
  setInterval(() => {
    ...
    var e = document.dispatchEvent(
      new KeyboardEvent("keydown", { key: targetElm })
    );
...
function envLevel2() {
  ...
  addElement(
    "outside_bush_down_right_1 board",
    "right",
    385,
    "down",
    -1,
  ...
  addElement(
    "outside_bush_down_right2 board",
    "right",
    170,
    "down",
    5,
...
function envLevel3() {
  ...
  let burning_tree_up_left = addElement(
    "burning_tree_up_left board",
    "left",
    302,
    "down",
    170,
...
function envLevel4() {
  ...
  let outside_bush_left = addElement(
    "outside_bush_left board",
    "left",
    5,
    "top",
    90,
  ...
  let outside_bush_left2 = addElement(
    "outside_bush_left board",
    "left",
    5,
    "top",
...
function deleteFire(ele, index) {
  ele.addEventListener("click", function() {
    if (nbExt >= 1) {
      ...
      nbExt--;
      let selectExt1 = document.querySelector(
        ".click_extinguisher .number_weap"
      );
      selectExt1.innerHTML = nbExt;
      if (nbExt == 0) {
        let selectExt1Img1 = document.querySelector(
          ".click_extinguisher .circle__weap.red"
        );
        let selectExt1Img2 = document.querySelector(
          ".click_extinguisher .circle__weap.none"
        );
    ...
    for (let z = 0; z < listLogs.length; z++) {
      listLogs[z].addEventListener("click", function() {
        if (nbAxe >= 1) {
          ...
          selectAxe1.innerHTML = nbAxe;
          if (nbAxe == 0) {
            let selectAxe1Img1 = document.querySelector(
              ".click_axe .circle__weap.red"
            );
            let selectAxe1Img2 = document.querySelector(
              ".click_axe .circle__weap.none"
            );
